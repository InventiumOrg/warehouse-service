...
runcontainer:
	podman run --network inventium --name warehouse-service -p 7450:7450 -d -e DB_SOURCE="postgresql://root:secret@postgres-1:5432/warehouse-service?sslmode=disable" -e CLERK_KEY="sk_test_XhHg2KNAIqm9I65JwOgQbLajZj6UqeeLTnpjx1p4oa" warehouse-service
